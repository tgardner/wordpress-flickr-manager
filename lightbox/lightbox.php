...
function showLightbox(objLink)
{
	...
	imgPreload.onload = function() {
		objImage.src = objLink.getAttribute("href");
	...
	imgPreload.src = objLink.getAttribute("href");
...
function initLightbox()
{
	...
	for (var i=0; i < anchors.length; i++){
		...
		if (anchor.getAttribute("href") && (anchor.getAttribute("rel") == "flickr-mgr")){
			anchor.onclick = function () {
				var image = this.getElementsByTagName("img");
				image = image[0];
				save_url = this.getAttribute("href");
				save_anchor = this;
				var image_link = image.getAttribute("src").split("_");
				if(image_link[image_link.length - 1].match(/[s,t,m]\.jpg/)) {
					image_link.pop();
					image_link[image_link.length - 1] = image_link[image_link.length - 1] + ".jpg";
				}
