...
var flickr_close = plugin_dir + 'lightbox/images/closelabel.gif';
// --------------------------------------------------------------------------
...
//
var FlickrLightbox = Class.create();

FlickrLightbox.prototype = {
	...
	initialize: function() {	
		...
		objLoadingImage.setAttribute('src', flickr_loading);
		...
		objBottomNavCloseImage.setAttribute('src', flickr_close);
...
function initLightbox() { myLightbox = new FlickrLightbox(); }
